...
- [ ] Plugin system for Orbit extensions
...
- [csharp_interop README](../../C#/csharp_interop/README.md) - MESharp API layer
- [WPF Debug Utility README](../../C#/ME_CSharp_Scripts/ME-wpf-debug/README.md) - Example script integration
- [CLAUDE.md](../../CLAUDE.md) - Full project architecture
- [ORBIT_INTEGRATION_PLANS.md](../../ORBIT_INTEGRATION_PLANS.md) - Integration roadmap
